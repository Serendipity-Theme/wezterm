...
Import in `wezterm.lua`: `config.color_scheme = "Serendipity Midnight"` after loading the TOML.

Available files: `serendipity-midnight.toml`, `serendipity-morning.toml`, `serendipity-sunset.toml`.
